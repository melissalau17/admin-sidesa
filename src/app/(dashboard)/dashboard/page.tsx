...
export default function DashboardPage() {
   return (
      <div className="space-y-6">
         ...
         <p className="text-muted-foreground">Selamat Datang di panel administrasi desa</p>
         </div>
         ...
         <SummaryCard title="Laporan Keuangan" subtitle="Ringkasan keuangan desa bulan ini">
            <div className="space-y-4">
               ...
               <div>
                  ...
                  <p className="text-2xl font-bold text-green-600">Rp 45,000,000</p>
               </div>
               <div>
                  <p className="text-sm font-medium">Pengeluaran</p>
                  <p className="text-2xl font-bold text-red-600">Rp 32,500,000</p>
               </div>
               </div>
               <div>
         ...
         <SummaryCard title="Aktivitas Terbaru" subtitle="Aktivitas terbaru di desa">
            <div className="space-y-4">
               ...
               <div>
                  <p className="text-sm font-medium">Permohonan surat keterangan domisili</p>
               ...
               <div>
                  <p className="text-sm font-medium">Laporan kerusakan jalan desa</p>
